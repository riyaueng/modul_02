...
const singersYear: Singer[] = [...singers]

singersYear.sort((career1: Singer, career2: Singer) => {
  return career1.period_active.start - career2.period_active.start
})
console.log(singersYear)
